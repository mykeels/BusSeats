...
String.prototype._toSentenceCase = function () {
    ...
    for (var i = 1; i < s.length; i++) {
        f += s.toLocaleLowerCase().charAt(i);
    }
    return f;
}

String.prototype._capitaliseEachWord = function () {
    var s = this.valueOf();
    var ret = "";
    var ss = s.split(" ");
    ss.each(function (word) {
        ret += word._toSentenceCase() + " ";
    });
    return ret;
}
...
String.prototype.DecodeURI = function () {
    ...
    s = s._replace("-", " ");
    s = s._replace("and", "&");
    return decodeURI(s)._toSentenceCase();
}